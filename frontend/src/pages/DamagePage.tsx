...
const columns = [
    ...
    { title: 'QC by', dataIndex: 'qc_by', key: 'qc_by', width: 120 },
];
...
const formFields = (
    <>
        ...
        <Form.Item name="qc_by" label="QC by"><Input /></Form.Item>
    </>
);

const csvHeaders = ['date', 'brand', 'sku', 'description', 'qty', 'damage_note', 'damage_reason', 'operator', 'qc_by'];
