...
export default function LocationPage() {
    ...
    const handleClearAll = () => {
        Modal.confirm({
            ...
            content: `Apakah Anda yakin ingin menghapus SEMUA ${data.length} data Master Location? Tindakan ini tidak bisa dibatalkan!`,
            ...
            onOk: async () => {
                try {
                    ...
                    message.success('Semua data Master Location berhasil dihapus');
                    setSelectedKeys([]);
                    fetchData();
    ...
    const columns: ColumnsType<LocationRecord> = [
        ...
        { title: 'Location Type', dataIndex: 'location_type', key: 'location_type', width: 120 },
        {
            ...
            render: (v: string) => {
                if (!v) return <span style={{ color: 'rgba(255,255,255,0.3)' }}>-</span>;
