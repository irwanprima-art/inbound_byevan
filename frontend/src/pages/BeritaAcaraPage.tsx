                                ...
                                {items.length > 0 && (
                                    <Table
                                        ...
                                        columns={[
                                            ...
                                            ...(isBarangTidakSesuai ? [
                                                {
                                                    ...
                                                    render: (v: string, _: any, i: number) => (
                                                        <Input value={v} size="small" placeholder="Deskripsi"
                                            ...
                                            ...(isBarangKurangLebih ? [
                                                {
                                                    title: isBarangTidakSesuai ? 'Qty DO' : 'Qty PO', dataIndex: 'qty_po', key: 'qty_po', width: 90,
                                                ...
                                                {
                                                    title: isBarangTidakSesuai ? 'Qty Fisik' : 'Qty Actual', dataIndex: 'qty_actual', key: 'qty_actual', width: 100,
                                                    render: (v: number, _: any, i: number) => (
                                                        <Input type="number" min={0} value={v} size="small" style={{ width: 75 }}
                                                ...
                                                {
                                                    title: isBarangTidakSesuai ? 'Selisih' : 'Qty Diff', key: 'qty_diff', width: 90,
                            ...
                            <table style={{ width: '100%', borderCollapse: 'collapse', margin: '16px 0' }}>
                                <thead>
                                    <tr>
                                        ...
                                        {(docForPreview.doc_type === 'Pemberitahuan Barang Kurang' || docForPreview.doc_type === 'Pemberitahuan Barang Lebih' || docForPreview.doc_type === 'Pemberitahuan Barang Tidak Sesuai') ? (
                                            <>
                                                <th style={printTh}>{docForPreview.doc_type === 'Pemberitahuan Barang Tidak Sesuai' ? 'Qty DO' : 'Qty PO'}</th>
                                                <th style={printTh}>{docForPreview.doc_type === 'Pemberitahuan Barang Tidak Sesuai' ? 'Qty Fisik' : 'Qty Actual'}</th>
                                                <th style={printTh}>{docForPreview.doc_type === 'Pemberitahuan Barang Tidak Sesuai' ? 'Selisih' : 'Qty Diff'}</th>
                                            </>
                                        ) : (
